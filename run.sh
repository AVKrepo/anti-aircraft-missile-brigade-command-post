...
echo
psql -U observer_ivanov -d postgres -f actions/observe.sql
...
echo
psql -U operator_petrov -d postgres -f actions/insert_new_radar_data.sql
echo
psql -U observer_ivanov -d postgres -f actions/observe.sql
...
echo
psql -U colonel_sidorov -d postgres -f actions/update_divisions.sql
echo
psql -U colonel_sidorov -d postgres -f actions/observe.sql
